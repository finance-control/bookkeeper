...
internal class SpendingAccountValidatorImplTest {

    private val accountValidation = mockk<AccountValidation>()

    private lateinit var accountValidatorImpl: SpendingAccountValidatorImpl

    @BeforeEach
    fun setup() {
        accountValidatorImpl = SpendingAccountValidatorImpl(accountValidation)
    }
