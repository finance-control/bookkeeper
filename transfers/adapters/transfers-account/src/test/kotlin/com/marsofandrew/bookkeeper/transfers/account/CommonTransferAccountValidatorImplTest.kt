...
internal class CommonTransferAccountValidatorImplTest {

    private val accountValidation = mockk<AccountValidation>()

    private lateinit var accountValidatorImpl: TransferAccountValidatorImpl

    @BeforeEach
    fun setup() {
        accountValidatorImpl = TransferAccountValidatorImpl(accountValidation)
    }
